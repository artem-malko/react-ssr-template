...
import { Alignment, Placement, Popover } from 'application/shared/kit/popover';

export const StaticDataComponent = memo(() => {
...
StaticDataComponent.displayName = 'StaticDataComponent';
